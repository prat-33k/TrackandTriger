...
import com.example.oopsapplication.models.WorkToDo;
...
public class worktodo extends AppCompatActivity {
    ...
    private DatabaseReference dbRef = database.getReference("work-to-do/"+uid);

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_worktodo);
        ...
        calendar.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            public void onClick(android.view.View v) {
                Intent intent2 = new Intent(worktodo.this,thecalendar.class);
    ...
    public void addItem(android.view.View view) {
        ...
        WorkToDo newWorkToDo = new WorkToDo(note,
                item);
        String key = dbRef.push().getKey();

        itemText.setText("");
        notes.setText("");
        dbRef.child(key).setValue(newWorkToDo);
