...
public class chorestodo extends AppCompatActivity {
    ArrayList<String> listItems = new ArrayList<String>();
    ArrayList<String> listKeys = new ArrayList<String>();
    ArrayList<String> listDetails = new ArrayList<String>(); //1
    ...
    private DatabaseReference dbRef = database.getReference("chores-to-do/"+uid);


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_chorestodo);
        ...
        dataListView.setOnItemClickListener(
                new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, android.view.View view, int position, long id) {
                        ...
                        itemSelected = true;
                        deleteButton.setEnabled(true);
                        notes.setText(listDetails.get(position)); //2
                    }
        ...
        calendar.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            public void onClick(android.view.View v) {
                Intent intent2 = new Intent(chorestodo.this,thecalendar.class);
    ...
    private void addChildEventListener() {
        ChildEventListener childListener = new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                listDetails.add((String) dataSnapshot.child("details").getValue()); //3
