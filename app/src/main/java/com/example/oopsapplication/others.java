...
public class others extends AppCompatActivity {
    ...
    private DatabaseReference dbRef = database.getReference("other-record");
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calendar.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            public void onClick(android.view.View v) {
                Intent intent2 = new Intent(others.this,thecalendar.class);
    ...
    public void addItem(android.view.View view) {
        ...
        dbRef.child(key).child("details").setValue(note);
