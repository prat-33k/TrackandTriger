...
public class workscratch extends AppCompatActivity {
    ...
    private DatabaseReference dbRef = database.getReference("professional-scratchpad/"+uid);
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_workscratch);
        ...
        calendar.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            public void onClick(android.view.View v) {
                Intent intent2 = new Intent(workscratch.this,thecalendar.class);
