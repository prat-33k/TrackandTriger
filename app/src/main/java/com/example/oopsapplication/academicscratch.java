...
public class academicscratch extends AppCompatActivity {
    ...
    private DatabaseReference dbRef = database.getReference("academic-scratchpad/"+uid);


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_academicscratch);
        ...
        calendar.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            public void onClick(android.view.View v) {
                Intent intent2 = new Intent(academicscratch.this,thecalendar.class);
