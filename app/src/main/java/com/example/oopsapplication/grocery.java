...
public class grocery extends AppCompatActivity {
    ...
    ArrayList<String> listDetails = new ArrayList<String>(); //A
    ...
    String uid = FirebaseAuth.getInstance().getCurrentUser().getUid();//2
    private DatabaseReference dbRef = database.getReference("grocery/"+uid);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataListView.setOnItemClickListener(
                new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, android.view.View view, int position, long id) {
                        ...
                        itemSelected = true;
                        deleteButton.setEnabled(true);
                        notes.setText(listDetails.get(position)); //B
                    }
        ...
        calendar.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            public void onClick(android.view.View v) {
                Intent intent2 = new Intent(grocery.this,thecalendar.class);
    ...
    private void addChildEventListener() {
        ChildEventListener childListener = new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                listDetails.add((String) dataSnapshot.child("details").getValue()); //C
    ...
    public void addItem(android.view.View view) {
        ...
        Grocery newGrocery = new Grocery(note, item);
        String key = dbRef.push().getKey();
        itemText.setText("");
        notes.setText("");
        dbRef.child(key).setValue(newGrocery);
        adapter.notifyDataSetChanged();
