...
public class choresscratch extends AppCompatActivity {
    ...
    private DatabaseReference dbRef = database.getReference("chores-scratchpad/"+uid);

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_choresscratch);
        ...
        calendar.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            public void onClick(android.view.View v) {
                Intent intent2 = new Intent(choresscratch.this,thecalendar.class);
