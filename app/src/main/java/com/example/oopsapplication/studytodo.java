...
public class studytodo extends AppCompatActivity {
    ...
    private DatabaseReference dbRef = database.getReference("study-to-do/"+uid);

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_studytodo);
        ...
        calendar.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            public void onClick(android.view.View v) {
                Intent intent2 = new Intent(studytodo.this,thecalendar.class);
